package com.csnt.titlestatusbar.viewUtils;
...
import com.csnt.titlestatusbar.statusBar.SystemBarTintManager;
...
public class StatusBarUtil {
    ...
    public static void setDefaultStatusBar(Activity activity){
        ...
        if (!setStatusBarDarkTheme(activity, false)) {
